...
ORDER_MANAGE_DISCOUNT = {
    ...
    init: function () {
        ...
        $.scrollLoadInterval({
            runIn: this,                               //�Ӹ��ص�ִ�ж���
            mainDiv: $(".list_discount_info"),                        //@param:jqobj     �б���Ҫ�����obj
            buttonLength: 200,                         //@param:int       ����ײ����ٿ�ʼ�������,Ĭ��200
            getDataApiName: "getDiscountCodeList",          //@param:str       ���õ�api�ӿ���
            bindDataFn: this.bindData,                  //@param:function ��ݰ󶨺���
            scrollForKey: "DiscountId",                 //@param:str       ����������Ҫ��key
            searchData: {
    ...
    bindData: function (data) {
        var parentDOM = $(".list_discount_info");//�б?��
    ...
    search: function () {
        ...
        window.location.href = "order_manage_discount.html?mainid=4&searchKey=" + encodeURIComponent(this.rehref);
    }
};
